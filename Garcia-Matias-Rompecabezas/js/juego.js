...
Se te ocurre cómo solucionar esto con una variable temporal? hacer una variable extra 
*/

function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {

    var nuevaPosicion = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = nuevaPosicion;
